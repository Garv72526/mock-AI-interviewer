...
# ============================================================
# ROUTE 1: POST /start
# Upload resume + select role → get session_id + first question
# ============================================================
...
# ============================================================
# TEST IN TERMINAL after python app.py:
#
# 1. Start interview:
...
#   -d "{\"session_id\":\"abc12345\",\"answer\":\"I used TF-IDF and LR\"}"
#
# 3. Keep answering until done=true
#
# 4. Get summary:
# curl http://localhost:5003/summary/abc12345
# ============================================================
